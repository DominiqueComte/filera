...
package net.sourceforge.filera.spi;

import net.sourceforge.rafc.spi.AbstractResourceAdapter;


/**
 * Provides access to files stored in local and remote file systems.
 * 
 * @author Markus KARG (markus-karg@users.sourceforge.net)
 */
public final class FileResourceAdapter extends AbstractResourceAdapter {
