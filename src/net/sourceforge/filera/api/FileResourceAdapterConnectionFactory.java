...
/**
 * Interface of the connection factory of the file resource adapter.
 * 
 * @author Markus KARG (markus-karg@users.sourceforge.net)
 */
public interface FileResourceAdapterConnectionFactory {

    /**
     * Returns a connection to the local file system.
     * 
     * @return a connection to the local file system.
     * @throws FileResourceAdapterException
     *                   when no connection could get obtained
     */
    public FileResourceAdapterConnection getConnection() throws FileResourceAdapterException;
